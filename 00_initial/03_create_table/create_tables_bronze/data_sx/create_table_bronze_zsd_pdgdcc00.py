...
# MAGIC %sql
# MAGIC drop table if exists bronze.zsd_pdgdcc00 ;
# MAGIC create table bronze.zsd_pdgdcc00
# MAGIC (
# MAGIC MANDT STRING
...
# MAGIC LOCATION '/mnt/data_sx/bronze/zsd_pdgdcc00'
# MAGIC     
