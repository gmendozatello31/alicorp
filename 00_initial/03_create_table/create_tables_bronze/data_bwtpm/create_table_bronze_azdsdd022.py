...
# MAGIC %sql
# MAGIC drop table if exists bronze.azdsdd022 ;
# MAGIC create table bronze.azdsdd022
# MAGIC (
...
# MAGIC ,BICZRLIST string
# MAGIC ,BICZRCOGS string
# MAGIC ,BJBPBS_RCOGS_S string
# MAGIC ,BJBPBS_RLIST_S string
# MAGIC 
# MAGIC 
...
# MAGIC LOCATION '/mnt/data_bwtpm/bronze/azdsdd022'
# MAGIC     
